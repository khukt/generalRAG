...
def generate_text(model, tokenizer, task_type, question, context, max_length, num_beams, no_repeat_ngram_size, early_stopping, use_template, templates, question_type):
    try:
        ...
        combined_input_text = f"{task_type}: {context} {question}"
        return format_output(answer), memory_footprint, attentions, combined_input_text
...
if question:
    ...
    with st.spinner("Generating..."):
        guide, memory_footprint, attentions, combined_input_text = generate_text(model, tokenizer, task_type, question, context, max_length, num_beams, no_repeat_ngram_size, early_stopping, use_template, template_manager.get_templates(), question_type)
    ...
    if attentions is not None:
        ...
        highlighted_text = highlight_text(tokenizer, combined_input_text, normalized_attentions)
