...
memory_usage_data = {"Initialization": 0}  # Initialize memory usage data with the initialization step
...
def plot_memory_usage():
    ...
    plt.barh(y_pos, memory_values, align='center', alpha=0.8)
    plt.yticks(y_pos, components)
    plt.xlabel('Memory Usage (MB)')
    plt.title('Memory Usage of Components')
    plt.grid(axis='x')
    plt.show()
